...
<ul>
  ...
  <li><a href="http://dnsfmwad.centralus.cloudapp.azure.com/Module_03/Project/contact.html">Contact us</a></li>
  <li><a class="active" href="http://dnsfmwad.centralus.cloudapp.azure.com/Module_03/Project/mySQL.php">Item Index</a></li>
</ul>

<div class="Featured">
  <img src="https://images.cooltext.com/5210642.png"/>
...
echo "<table style='border: solid 3px #C0AB8E;'>";
 echo "<tr><th>Item Number</th><th>Item Name</th><th>Item Description</th><th>Price</th><th>Available Sizes</th></tr>";
...
try {
    ...
    $stmt = $conn->prepare("SELECT id, product_name, product_d, price, sizes FROM stock");
    $stmt->execute();
